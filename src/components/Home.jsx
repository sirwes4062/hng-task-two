    ...
    <React.Fragment>
      <div className="container">
        <header>
          ...
          <h3 className="twitter-name" id="twitter">
        ...
        <div className="body">
          ...
          <a
            ...
            id="pitch"
            title="eager to learn python,this are python programming books for beginners"
          >
            <div className="link-section">
          ...
          <a
            ...
            id="book__design"
            text="you pitch a service for doing background checks on coders"
          >
            <div className="link-section">
          ...
          <a
            ...
            id=""
            text=" you pitch the free design book offered by Zuri"
          >
            <div className="link-section">
          ...
          <div className="link-section">
                  <h4 className="link">Contact Me</h4>
                </div>
          </Link>
        </div>
